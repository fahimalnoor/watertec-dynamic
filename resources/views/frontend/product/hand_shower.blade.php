      ...
      <a href="{{url('hand-shower')}}" class="grid-link">           
        ...
        <div class="reveal"> 
          <span class="product-additional">      
            <img src="{{ asset('public/frontend/cdn/s/files/1/0045/0523/9670/products/new/hs1.jpg?v=1532428466') }}" class="featured-image" alt="12&quot; Rain Shower">
          </span>
          <img  src="{{ asset('public/frontend/cdn/s/files/1/0045/0523/9670/products/new/hs1.jpg?v=1532428466') }}" class="hidden-feature_img" alt="12&quot; Rain Shower" />
        </div>      
  ...
  <div class="products product-hover-16">
    <div class="product-container">  
      ...
      <a href="{{url('hand-shower')}}" class="grid-link">            
        ...
        <div class="reveal"> 
          <span class="product-additional">      
            <img src="{{ asset('public/frontend/cdn/s/files/1/0045/0523/9670/products/new/hs2.jpg?v=1532438114') }}" class="featured-image" alt="15-Litre Water Heater">
          </span>
          <img  src="{{ asset('public/frontend/cdn/s/files/1/0045/0523/9670/products/new/hs2.jpg?v=1532438114') }}" class="hidden-feature_img" alt="15-Litre Water Heater" />
        </div>      
  ...
  <div class="products product-hover-16">
    <div class="product-container">  
      ...
      <a href="{{url('hand-shower')}}" class="grid-link">           
        ...
        <div class="reveal"> 
          <span class="product-additional">      
            <img src="{{ asset('public/frontend/cdn/s/files/1/0045/0523/9670/products/new/hs3.jpg?v=1532437397') }}" class="featured-image" alt="2000-Watt Water Heater">
          </span>
          <img  src="{{ asset('public/frontend/cdn/s/files/1/0045/0523/9670/products/new/hs3.jpg?v=1532437400') }}" class="hidden-feature_img" alt="2000-Watt Water Heater" />
        </div>      
