...
<div class="content-wrapper">
            <div class="content">
                <div class="container-fluid">
                    <div class="content-header">
                        <h6 class="m-0 text-color">Home > Logo > <span>Logo Management</span></h6>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="text-color">Logo</h5>
                                </div>
                                <div class="card-body">
                ...
                <div class="modal fade" id="exampleModal{{$all_logo->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <form action="{{ url('/admin/logo/update', $all_logo->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group" >
                                            <p>Edit Status:</p>
                                        <input type="radio" id="active" name="logo_status" value="Active">
                                        <label for="active">Active</label><br>
                                        <input type="radio" id="inactive" name="logo_status" value="Inactive">
    ...
    @endforeach
                              ...
                              <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                    <h5 class="text-color">Add Logo</h5>
                                        </div>
