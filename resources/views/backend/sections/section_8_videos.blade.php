...
<div class="content-wrapper">
            <div class="content">
                <div class="container-fluid">
                    <div class="content-header">
                        <h6 class="m-0 text-color">Home > Sections > <span>Section-8 Video Content</span></h6>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="text-color">Video Contents</h5>
                                </div>
                                <div class="card-body">
    ...
    @endforeach
                              ...
                              <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                    <h5 class="text-color">Add Video</h5>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sec_name" name="sec_name" value="section_8" readonly>
                                        </div><br>
                                        <div class="form-group">
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="image" id="image">
                                                <label class="custom-file-label" for="image">Choose Preview Image (Optional)</label>
                                            </div>
                                        </div>
