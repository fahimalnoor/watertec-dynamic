            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="content-header">
                        <h6 class="m-0 text-color">Home > Sections > <span>Section-4 Gallary Content</span></h6>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="text-color">Gallary Section Contents</h5>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card">
                                    ...
                                    <h5 class="text-color">Add Content</h5>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="sec_name" name="sec_name" value="section_4" readonly>
                                        </div><br>
                                        <div class="form-group">
